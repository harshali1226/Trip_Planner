...
class WeatherInfoTool:
    ...
    def _setup_tools(self) -> List:
        ...
        def get_current_weather(city: str) -> str:
            ...
            coords = self.weather_service.geocode_place(city)
            if not coords:
                return f"Could not determine location for {city}"

            weather_data = self.weather_service.get_current_weather_by_coordinates(
        ...
        def get_weather_forecast(city: str) -> str:
            ...
            forecast_data = self.weather_service.get_forecast_weather_by_coordinates(
                coords["lat"], coords["lon"]
            )
